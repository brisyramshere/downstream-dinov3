...
class DinoV3_DPT(nn.Module):
    ...
    """
    def __init__(self, backbone_name: str = 'dinov3_vits16', num_classes: int = 150, features=128, skip_connection_layers: List[int] = [2, 5, 8, 11]):
        super().__init__()
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return F.interpolate(logits, size=(img_h, img_w), mode='bilinear', align_corners=True)
