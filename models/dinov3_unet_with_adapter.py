...
from models.backbones import load_dinov3_backbone, DINOv3_INTERACTION_INDEXES
...
class DinoV3_UNetWithAdapter(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.interaction_indexes = DINOv3_INTERACTION_INDEXES[backbone_name]
