...
if __name__ == '__main__':
    ...
    try:
        ...
        print("\nTesting ImageNetClassificationDataset...")
        train_dataset = ImageNetClassificationDataset(root_dir=dummy_root, split='train')
        val_dataset = ImageNetClassificationDataset(root_dir=dummy_root, split='val')
